    ...
    <header>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto"> <!-- ms-auto aligns the navbar items to the right -->
                <li class="nav-item"><a class="nav-link" href="index_employee.php">Home</a></li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="servicesDropdown" role="button" data-bs-toggle="dropdown">Services</a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="goodmoral_employee.php">Good Moral Certificate</a>
                        <a class="dropdown-item" href="feedback_employee.php">Share Your Feedback</a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true): ?>
                            <a class="dropdown-item" href="profile_employee.php">Profile</a>
    ...
    <div class="profile-container">
        <div class="profile-header">
            <div>
                ...
                <p id="profile-position">Counselor</p>
            </div>
            <div>
            ...
            <div class="profile-info">
                ...
                <div>
                    ...
                    <select id="position" disabled>
                        <option value="cs" selected>Counselor</option>
                        <option value="it">Staff</option>
                        <option value="se">Faculty</option>
                    </select>
                </div>
                <div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const profileName = document.getElementById('profile-name'); // Profile name element
        const profilePosition = document.getElementById('profile-position'); // Profile position element
        ...
        editButton.addEventListener('click', function () {
            ...
            formElements.forEach(element => {
                if (element.disabled) {
                    ...
                    // Update the profile name and position when saved
                    if (firstNameField.value && lastNameField.value) {
                        profileName.textContent = `${firstNameField.value} ${lastNameField.value}`; // Update the name in profile header
                    }
                    if (positionField.value) {
                        // Update the position in profile header
                        const selectedPosition = positionField.options[positionField.selectedIndex].text;
                        profilePosition.textContent = selectedPosition;
                    }
