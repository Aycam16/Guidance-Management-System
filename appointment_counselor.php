...
<body>
    ...
    <tbody>
        ...
        $appointments = [
            ...
            ["appointment_date" => "Counselor Name", "appointment_time" => "Counselor Name", "full_name" => "Name", "email" => "Name", "student_number" => "Name", "course" => "Name", "section" => "Name", "reason" => "Name", "status" => "Upcoming"],
            ["appointment_date" => "Counselor Name", "appointment_time" => "Counselor Name", "full_name" => "Name", "email" => "Name", "student_number" => "Name", "course" => "Name", "section" => "Name", "reason" => "Name", "status" => "Upcoming"],
        ];
